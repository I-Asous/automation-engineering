...
from datetime import datetime, timezone #work with dates and times
from dotenv import load_dotenv #load environment variabels
from twilio.rest import Client #twilio client imported for messages and services
import os #get directories / work with file paths
...
def get_q69_arrivals() -> str:
    ...
    for bus in visits[:3]:
        ...
        mins = max(0, round((eta - now).total_seconds() / 60)) # trying to see if its more accurate for the first sotp
